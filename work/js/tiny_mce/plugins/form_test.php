...
<script type="text/javascript">
	...
	*/
	...
	{
		var win = window.open('http://localhost/tinymce/jscripts/tiny_mce/plugins/ajaxfilemanager/ajaxfilemanager.php?editor=form&elementId='+elementId, 'ajaxFileImageManager', 'width=782,height=440');		
		return false;
	}
</script>
</head>
