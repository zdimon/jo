<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,createdoc,separator,refresh,upload,props,separator,cut,copy,paste,delete,unzip";
	...
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../../upl_files'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,doc,rar,avi,mpeg4";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,doc,rar";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,avi,mpeg4";
