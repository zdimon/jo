...
<body>
    ...
    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="240" height="180"  align="middle">
        <param name="movie" value="/chat5.swf" />
        ...
        <param name="FlashVars" value="streamName=user911&url=<?= $url ?>&micOn=false&type=out" />
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="/chat.swf" width="240" height="180">
            ...
            <param name="salign" value="" />
            <param name="allowScriptAccess" value="always" />
            <param name="FlashVars" value="streamName=user911&url=<?= $url ?>&micOn=true&type=out" />
            <!--<![endif]-->
