...
<p><a style="display: block; width: 100px; margin-bottom: 2px" target="_blank" href="<?= url_for('http://'.$_SERVER['HTTP_HOST'].'/profile/superlogin?salt='.$profile->getsfGuardUser()->getSalt()) ?>" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-check"></span><?= __('Login under user') ?></span></a></p>
