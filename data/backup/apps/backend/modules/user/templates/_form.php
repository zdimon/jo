    ...
    <div class="row">
      ...
      <div class="row">
         <?php echo $form['real_name']->renderLabel(null, array('class' => 'required star')) ?><span class="required">*</span>
		  ...
		  <div class="help"><?= __('Show on the site') ?></div>
     </div>
...
<div class="fg-toolbar ui-widget-header ui-corner-all">
  ...
  <div class="row">
      <?php echo $form['email']->renderLabel(null, array('class' => 'required star')) ?><span class="required">*</span>
      <?php echo $form['email'] ?>
...
<div class="fg-toolbar ui-widget-header ui-corner-all">
    ...
    <h1><?= __('About partner') ?></h1>
      ...
      <div class="row">
                <div class="sub_row">
		<?php echo $form['looking_for_age_from']->renderLabel() ?><span class="required">*</span>
  ...
  <div class="row">
      <label><?= __('Certificated') ?> </label>
      <?php echo $form['cert'] ?>
      <?php echo $form['cert']->renderError() ?>
  </div>
