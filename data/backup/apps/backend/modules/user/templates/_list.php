  ...
  <table>
    ...
    <tbody>
      <?php foreach ($pager->getResults() as $i => $profile): $odd = fmod(++$i, 2) ? ' odd' : '' ?>
        <tr class="sf_admin_row ui-widget-content <?php echo $odd ?>" <?php if($profile->getStatusId()==2) echo 'style="background: #FFAFAF"' ?> <?php if($profile->getScamer()) echo 'style="background: #777674"' ?>>
