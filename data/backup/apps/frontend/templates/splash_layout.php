...
<div class="s_wrap">
    ...
    <div class="s_bg">
        ...
        <div class="flags">
            <a href="<?= url_for('http://www.our-feeling.com/is/lang/index?l=is&mp=1&put=1') ?>"><img src="/pic/f_sp.png" alt=""></a>
            <a href="<?= url_for('http://www.our-feeling.com/ru/lang/index?l=ru&mp=1&put=1') ?>"><img src="/pic/f_ru.png" alt=""></a>
            <a href="<?= url_for('http://www.our-feeling.fr/fr/lang/index?l=fr&mp=1&put=1') ?>"><img src="/pic/f_fr.png" alt=""></a>
            <a href="<?= url_for('http://www.our-feeling.de/de/lang/index?l=de&mp=1&put=1') ?>"><img src="/pic/f_ger.png" alt=""></a>
            <a href="<?= url_for('http://www.our-feeling.com/en/lang/index?l=en&mp=1&put=1') ?>"><img src="/pic/f_usa.png" alt=""></a>
        </div>
