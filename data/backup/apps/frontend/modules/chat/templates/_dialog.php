...
<?php if($new_message):?>
    ...
    <?php
        $info = '<table><tr><td>'.$abonent->getProfile()->getFirstName().' '.$abonent->getProfile()->getLastName().'</td></tr><tr><td>&nbsp;ID:&nbsp;'.$abonent->getProfile()->getUserSpecId().'</td></tr><tr><td>&nbsp;'.$abonent->getProfile()->getAge().'</td></tr><tr><td>&nbsp;'.$abonent->getProfile()->getCity().'</td></tr><tr><td>&nbsp;'.$arrc[$abonent->getProfile()->getCountry()].'</td></tr></table>' ;
