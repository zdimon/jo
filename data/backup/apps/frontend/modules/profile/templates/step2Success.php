...
<?php // echo $form ?>
        ...
        <div id="tabs-2">
            ...
            <div class="row">
                <?php echo $form[$sf_user->getCulture()]['description']->renderLabel(null, array('class' => 'required star')) ?>
            ...
            <div class="row">
                <?php echo $form[$sf_user->getCulture()]['ideal_match_description']->renderLabel(null, array('class' => 'required star')) ?>
            ...
            <div class="row">
                <?php echo $form[$sf_user->getCulture()]['hobbies']->renderLabel(null, array('class' => 'required star')) ?>
