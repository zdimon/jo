<h1><?= __('Welcome in your area')?>: <?= $sf_user->getGuardUser()->getProfile()->getFirstName()?> <?= $sf_user->getGuardUser()->getProfile()->getLastName()?></h1>
    ...
    <div style="width:48%; float:left; margin:0 0 0 13px;">
        ...
        <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><?= $sf_user->getGuardUser()->getProfile()->getPacket()  ?></td>
            </tr>
            <tr>
    ...
    <div style="width:48%; float:left; margin:0 0 0 13px;">
        ...
        <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td><?= MessageTable::getCount($sf_user->getGuardUser())?></td>
            </tr>
            <tr>
                <th><?= link_to(__('New messages'),'message/personal') ?></th>
        ...
        <div><span class="but_2_wrap title_1 all_w"><span class="but_2 block"><?= __('Forum, Blog') ?></span></span></div>
        <table class="table1" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
