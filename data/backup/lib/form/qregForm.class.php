  ...
  public function configure()
  {
      ...
      unset(
               ...
               // $this->widgetSchema['birthday'] = new sfWidgetFormDateJQueryUI();
                ...
                $this->widgetSchema['culture'] =  new sfWidgetFormChoice(array('expanded'=>false,'choices' => array('en'=>__('English'),'ru'=>__('Russian'),'fr'=>__('French'),'de'=>'German','is'=>'Spanish')));
      ...
      $this->widgetSchema->setLabels(array(
          ...
          'captcha'   => __('Code'),
              ...
              //  );
                ...
                $custom_decorator = new sfWidgetFormSchemaFormatterqregList($this->getWidgetSchema());
...
class sfWidgetFormSchemaFormatterqregList extends sfWidgetFormSchemaFormatter {
    protected
